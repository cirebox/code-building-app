        ...
        try
          ...
          begin
            ...
            begin
              ...
              uCONTROLLER.SaveToFile(dm.CodeBuilding.DirSaida+'controllers\'+Tabelas.Nome+'.js');
            end;
          end;
        finally
        ...
        try
          ...
          begin
            ...
            begin
              ...
              uRoutes.SaveToFile(dm.CodeBuilding.DirSaida+'routes\v1\'+Tabelas.Nome+'.js');
            end;
          end;
        finally
          FreeAndNil(uRoutes);
        ...
        try
          ...
          begin
            ...
            begin
              ...
              uDocs.SaveToFile(dm.CodeBuilding.DirSaida+'docs\'+Tabelas.Nome+'.js');
            end;
          end;
        finally
          Tabelas.proximo;
