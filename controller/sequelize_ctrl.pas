      ...
      begin
        try
          ...
          begin
            ...
            begin
              uConfig.Add('''use strict''');
              uConfig.Add('require(''dotenv'').config({');
              uConfig.Add('  path: process.env.NODE_ENV === "test" ? ".env.test" : ".env"');
              uConfig.Add('})');
              uConfig.Add('');
              uConfig.Add('const config = {');
              uConfig.Add('  development: {');
              uConfig.Add('    database: process.env.DB_NAME,');
              uConfig.Add('    username: process.env.DB_USER,');
              uConfig.Add('    password: process.env.DB_PASS,');
              uConfig.Add('    dialect: process.env.DB_DIALECT || ''postgres'',');
              uConfig.Add('    host: process.env.DB_HOST,');
              uConfig.Add('    port: process.env.DB_PORT,');
              uConfig.Add('    storage: ''.__tests__/database.sqlite'',');
              uConfig.Add('    logging: false,');
              uConfig.Add('    pool: {');
              uConfig.Add('      max: 20,');
              uConfig.Add('      min: 0,');
              uConfig.Add('      idle: 10000,');
              uConfig.Add('    },');
              uConfig.Add('    dialectOptions: {');
              uConfig.Add('      options: {');
              uConfig.Add('        requestTimeout: 3000');
              uConfig.Add('      }');
              uConfig.Add('    },');
              uConfig.Add('    retry: {');
              uConfig.Add('      max: 2,');
